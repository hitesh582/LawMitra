      ...
      <div>
        ...
        <div>
          <Link to="/lawyerverification">
            <button className=" cursor-pointer hover:text-gray-300 transition-all duration-300 absolute top-[90%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[240px] h-[55px] object-contain z-20 bg-black text-white rounded-4xl">
